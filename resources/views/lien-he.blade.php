    ...
    <div class="container-fluid tm-mt-10" style="margin-left: 600px;">
        ...
        <div class="row tm-mb-50">
            <div class="col-lg-4 col-12 mb-5">
                ...
                <form action="{{ route('xl-gui-lien-he') }}" method="POST" class="tm-contact-form mx-auto">
                    @csrf
                ...
                <a href="{{ route('trang-chu') }}" style="display: inline;" class="btn btn-primary">Quay lại</a>
            </div>
        </div>
