                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button href="{{ route('admin-xoa-lien-he',['id' => $data->id]) }}" id="btn-del" type="button" class="btn btn-danger btn-del-lien-he"><i class="fa fa-trash-o"></i> Xóa </button>
