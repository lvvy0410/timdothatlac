                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Danh sách Bài đăng bị báo cáo</h3>
                        </div>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button href="{{ route('admin-xoa-bao-cao',['id' => $data->bai_dang_id]) }}" id="btn-del" type="button" class="btn btn-danger btn-del-bao-cao"><i class="fa fa-trash-o"></i> Xóa </button>
