    ...
    <div class="container-fluid tm-mt-10" style="margin-left: 600px;">
        ...
        <div class="row tm-mb-50">
            <div class="col-lg-4 col-12 mb-5">
                <h2 class="tm-text-primary mb-4">Thay đổi mật khẩu</h2>
                <form action="{{ route('user-xl-chinh-sua-mat-khau') }}" method="POST" class="tm-contact-form mx-auto">
                    @csrf
                    <div class="form-group">
                        <input type="password" name="mat_khau_cu" class="form-control rounded-0" placeholder="Nhập mật khẩu cũ" />
                    </div>
                    <div class="form-group">
                        <input type="password" name="mat_khau" class="form-control rounded-0" placeholder="Nhập mật khẩu mới" />
                    </div>
                    <div class="form-group">
                        <input type="password" name="xac_nhan_mat_khau" class="form-control rounded-0" placeholder="Xác nhận mật khẩu mới" />
                    </div>
